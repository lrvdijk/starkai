"""
:mod:`starkai.util` - Module with an influencemap implementation
================================================================

This module contains a class for creating and modifying influence maps.

.. module:: starkai.util
   :synopsis: Utility functions, datastructures and other classes
...
class Counter(dict):
	"""
		...
		This class is taken from the AI course at edx.org
	"""
